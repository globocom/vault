...
(function (window, $) {
  ...
  var options,
    ...
    item_tmpl = [
      ...
      'data-bs-toggle="tooltip" data-placement="left" data-object-name="<%=name%>" data-object-new-name="">',
  ...
  function _bind_edit_new_name_object_value(
    table_cell_for_object_new_name_value
  ) {
    $(table_cell_for_object_new_name_value).click(function () {
      ...
      $(this).html(
        "<input type='text' value='" + original_content + "' size='50'/>"
      );
  ...
  function _update_result_table(data) {
    ...
    $(".table-content tr").each(function (i, row) {
      ...
      if ($row.find("td")[1].innerText != original_object_name) {
        ...
        table_object_new_name_title.innerText =
          "Nome Sugerido [Caso precise clique no novo nome para edicao]";
