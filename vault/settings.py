...
SWIFT_CLOUD_TOOLS_URL = os.getenv("VAULT_SWIFT_CLOUD_TOOLS_URL")
SWIFT_CLOUD_TOOLS_API_KEY = os.getenv("VAULT_SWIFT_CLOUD_TOOLS_API_KEY")
# Swift-Cloud default parameters
...
OIDC_JWKS_URI = os.getenv("VAULT_OIDC_JWKS_URI")
